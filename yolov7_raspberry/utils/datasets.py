...
from yolov7_raspberry.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from yolov7_raspberry.utils.torch_utils import torch_distributed_zero_first
...
class LoadPiCamera:  # for inference
    ...
    def __next__(self):
        ...
        # Convert
        img = img.transpose((2, 0, 1))[:3,:,:]  # HWC to CHW, BGR to RGB
        img = np.ascontiguousarray(img)
